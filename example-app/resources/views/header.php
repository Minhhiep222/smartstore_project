            ...
            <div class="grid">
                <nav class="header__navbar">
                    <ul class="navbar-list">
                        ...
                        <li class="navbar-item">
                            <span class="navbar-title--no-pointer" >Kết nối </span>
                            <a href="" class="navbar-icon-link">
                                <i class="navbar-icon-link fa-brands fa-facebook"></i>
                            </a>
                            <a href="" class="navbar-icon-link">
                                <i class="navbar-icon-link fa-brands fa-instagram"></i>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="header-with-search">
                    <div class="header__logo">
                        <svg viewBox="0 0 192 65" class="header__logo-img shopee-svg-icon header-with-search__shopee-logo icon-shopee-logo">
