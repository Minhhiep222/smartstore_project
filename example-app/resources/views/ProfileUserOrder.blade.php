...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/profileUserOrder.css') }}">
</head>
<style>
    ...
    .main-ProfileUserOrder .topInfo-ProfileUser .btnDelete {
    display : flex;
    height : 37px;
    width : 100px;
...
.main-ProfileUserOrder .topInfo-ProfileUser .btnDelete h4 {
    color : red;
    font-size: 21px;
    margin-top: 5px;   
...
.main-ProfileUserOrder .topInfo-ProfileUser .btnDelete .fa-circle-minus {
    font-size : 16px;
    margin-top : 8px;
    margin-right : 10px;   
    color : black; 
